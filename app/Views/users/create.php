<?php $pageTitle = __('users.create_title'); ?>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">

<style>
.usr-form-hero{position:relative;background:linear-gradient(135deg,#22c55e 0%,#16a34a 50%,#059669 100%);border-radius:0 0 32px 32px;padding:40px 0 30px;margin:-1.5rem -15px 2rem;text-align:center;overflow:hidden}
...
.usr-form-hero-icon{width:64px;height:64px;border-radius:18px;background:rgba(255,255,255,0.2);backdrop-filter:blur(10px);border:2px solid rgba(255,255,255,0.3);display:inline-flex;align-items:center;justify-content:center;font-size:1.5rem;color:#fff;margin-bottom:1rem;box-shadow:0 8px 32px rgba(0,0,0,0.15)}
.usr-form-hero-title{font-size:1.8rem;font-weight:700;color:#fff;text-shadow:0 2px 8px rgba(0,0,0,0.1);margin-bottom:0.3rem}
...
.usr-form-header{padding:1.2rem 1.5rem;border-bottom:1px solid var(--border);display:flex;align-items:center;gap:0.6rem}
.usr-form-header h6{margin:0;font-weight:600;color:var(--text-primary)}
.usr-form-header i{color:var(--accent)}
...
@media(max-width:768px){
    ...
    .usr-form-hero-title{font-size:1.4rem}
}
</style>
...
<div class="usr-form-hero">
    ...
    <div class="usr-form-hero-content">
        <div class="usr-form-hero-icon"><i class="fas fa-user-plus"></i></div>
        <div class="usr-form-hero-title"><?= __('users.create_title') ?></div>
        <div class="usr-form-hero-sub">Remplissez les informations pour créer un nouveau compte</div>
    </div>
</div>
            ...
            <div class="usr-form-body">
                <form method="POST" action="/users/store">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="usr-form-group">
                                ...
                                <input type="text" class="usr-form-input" name="first_name" required placeholder="Prénom">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="usr-form-group">
                                <label><?= __('users.last_name') ?> <span class="required">*</span></label>
                                <input type="text" class="usr-form-input" name="last_name" required placeholder="Nom">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="usr-form-group">
                                ...
                                <input type="email" class="usr-form-input" name="email" required placeholder="email@exemple.dz">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="usr-form-group">
                                <label><?= __('users.phone_label_short') ?></label>
                                <input type="tel" class="usr-form-input" name="phone" placeholder="0555 55 55 55">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="usr-form-group">
                                ...
                                <input type="password" class="usr-form-input" name="password" required minlength="6" placeholder="Min. 6 caractères">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="usr-form-group">
                                ...
                                <select class="usr-form-select" name="status">
                                    ...
                                    <option value="pending"><?= __('users.pending') ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="usr-form-actions">
                        <button type="submit" class="usr-form-save"><i class="fas fa-check"></i> <?= __('users.create') ?></button>
                        <a href="/users" class="usr-form-cancel"><i class="fas fa-arrow-left"></i> <?= __('users.cancel') ?></a>
                    </div>
                </form>
            </div>
        </div>
